...
当然，如果是这种需要快速反应的机制，在前面蓄力的过程 Set ChargeTime 的时候 clamp 上限应该要设置成比 Self.MaxChargeTime 更多一些，让他可以蓄力超出上限。然后再增加一个 "Too slow" 或者  "Miss" 的等级，稍微宽限些 "Perfect" 的区间，或者即将到达 "Perfect" 的时候减缓速度，提高容错率等等。。这些细节就留给你自己设计了~ 举一反三
